...
```{r source_my_functions, warning=FALSE, message=FALSE}

# 외부파일에 함수를 정의함으로써 코드의 가독성을 높이고자 하였음
source("C:/R/Projects/R-4.4.0-Thyroid_Cancer_Prognosis/manuscripts/my_functions.R")
...
folder_path <- "C:/R/Projects/R-4.4.0-Thyroid_Cancer_Prognosis/manuscripts/raw_data/"
pattern <- "관심환자.*"
